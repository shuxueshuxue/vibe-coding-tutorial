...
我这里想指出大家经常忽略的一个 vibe coding 的优势：合理的 context 保存可以让中途加入的开发者快速了解项目当前的进展，以及让合作者互相知道对方做了什么，让合作中的沟通无比快捷。这种“热插拔”的便利对于个人也有用：我可以一个人并行开发多个项目，而不用担心忙完一个导致忘了另一个的细节。
